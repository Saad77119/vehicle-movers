    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Vehicle Make</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Make
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="modal-size-lg d-inline-block">
                              ...
                              <div class="modal-body">
                                 <div class="row">
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                          <label class="form-label" for="title">Company</label>
                                          <input type="text" id="company" class="form-control" placeholder="Enter Country..." name="name" required/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="modal fade text-start" id="edit_modal" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
                     <div class="modal-dialog modal-md">
                        <div class="modal-content">
                           <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel17">Edit Country</h4>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                           </div>
                              ...
                              <div class="modal-body">
                                 <div class="row">
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                          <label class="form-label" for="title">Company</label>
                                          <input type="text" id="edit_company" class="form-control" placeholder="Enter Country..." name="name" required/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
...
<script>
    $(document).ready(function() {
                ...
                "columnDefs": [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                '</a>'+
                                '<a href="javascript:;" onclick="delete_company('+full.id+')">' +
            ...
            $('div.head-label').html('<h6 class="mb-0">List of Makes</h6>');
    ...
    function edit(id) {
                rowid = id;
                $.ajax({
                    url: "{{url('makes')}}" + "/" + id + "/edit",
                    type: "get",
                    success: function (response) {
                        $("#edit_make").val(response.name);
