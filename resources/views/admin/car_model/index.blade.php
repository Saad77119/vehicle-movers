    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Vehicle Model</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Vehicle Model
                            </li>
                        </ol>
                    </div>
                </div>
                     ...
                     <div class="modal-dialog modal-md">
                        <div class="modal-content">
                           <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel17">Add Model</h4>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                          ...
                                          <input type="text" id="model" class="form-control" placeholder="Enter Model..." name="model" required/>
                                       </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                        <label class="form-label" for="make">Select Make</label>
                                          <select name="make_id" id="make" class="select2 form-select" required>
                                                <option value=""></option>    
                              ...
                              <div class="modal-body">
                                 <div class="row">
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                          <label class="form-label" for="title">Model</label>
                                          <input type="text" id="edit_model" class="form-control" placeholder="Enter Model..." name="model" required/>
                                       </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                       <div class="mb-1">
                                        <label class="form-label" for="make">Select Make</label>
                                          <select name="make_id" id="edit_make" class="select2 form-select" required>
                                                <option value=""></option>
                                                @foreach($make as $makes)
                                                    <option value="{{$makes->id}}">{{$makes->name}}</option>    
                                                @endforeach                                             
...
<script>
    $(document).ready(function() {
                ...
                "columnDefs": [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                '</a>'+
                                '<a href="javascript:;" onclick="delete_model('+full.id+')">' +
            ...
            $('div.head-label').html('<h6 class="mb-0">List of Models</h6>');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.errors){
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Model has been Added Successfully!'
                            })
                        }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response.errors){
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Model has been Updated Successfully!'
                            })
                        }
                    }
                });
    ...
    function edit(id) {
                rowid = id;
                $.ajax({
                    url: "{{url('models')}}" + "/" + id + "/edit",
                    type: "get",
                    success: function (response) {
                        $("#edit_model").val(response.model);
                        $("#edit_make").val(response.make).select2();
