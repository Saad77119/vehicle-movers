    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Countries</h2>
                     ...
                     <div class="modal-dialog modal-md">
                        <div class="modal-content">
                           <div class="modal-header">
                              <h4 class="modal-title" id="myModalLabel17">Add Country</h4>
                              ...
                              <div class="modal-body">
                                 <div class="row">
                                    <div class="col-md-12 col-12">
                                       <div class="mb-1">
                                          <label class="form-label" for="title">Country</label>
                                          <input type="text" id="edit_country" class="form-control" placeholder="Enter Country..." name="country" required/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
