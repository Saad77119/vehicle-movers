                        ...
                        <form class="form" id="add_form">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="landline">LandLine * (optional)</label>
                                            <input type="number" id="landline_no" class="form-control"
                                                placeholder="Enter No..." name="landline_no" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="type">Select Type of Customer</label>
                                            <select name="customer_type_id" id="type" class="select2 form-select" required>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="landline">LandLine * (optional)</label>
                                            <input type="number" id="edit_landline_no" class="form-control"
                                                placeholder="Enter No..." name="landline_no" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="type">Select Type of Customer</label>
                                            <select name="customer_type_id" id="edit_type" class="select2 form-select" required>
                                                <option value="Choose">Choose</option>
                                                @foreach($customer_types as $customer_type)
                                                <option value="{{$customer_type->id}}">{{$customer_type->type}}</option>
                                                @endforeach
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    if(data==0){
                            return (
                                '<input  type="checkbox" data-id="'+full.id+'" class="toggle-class" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-size="small" data-on="Active" data-off="Disable" checked>'
                            );
                        }
                        else{
                            return (
                                '<input  type="checkbox" data-id="'+full.id+'" class="toggle-class" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-size="small" data-on="Active" data-off="Disable">'
                            );
                        }
                }
            },
            {
                ...
                render: function(data, type, full, meta) {
                    return (
                        '<a href="javascript:;" class="item-edit" title="Edit" onclick=edit(' + full.id +
                        ')>' +
                        feather.icons['edit'].toSvg({
                            class: 'font-medium-4'
                        }) +
                        '</a>' +
                        '<a href="{{url("customers")}}'+'/'+full.id+'" title="View Profile" class="item-edit">' +
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.errors) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'Customers has been Added Successfully!'
                    })
                }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.errors) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'Customers has been Updated Successfully!'
                    })
                }
            }
        });
...
function edit(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $("#edit_type").val(response.customer_type_id).select2();
